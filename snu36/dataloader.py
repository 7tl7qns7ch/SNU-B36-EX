...
attribute_file = 'attribute/attribute_randomsplit8_spherical.csv'
...
np.save('SNU36_mel_10K_120_0.95_seen.npy', seen_features)
np.save('SNU36_mel_10K_120_0.95_unseen.npy', unseen_features)'''
...
#print(seen_encoding, unseen_encoding)

np.save('seen_target.npy', seen_target)
np.save('unseen_target.npy', unseen_target)

np.save('seen_class.npy', seen_encoding)
np.save('unseen_class.npy', unseen_encoding)'''
...
np.save('data_for_fg/att_spherical.npy', att)
#np.save('data_for_fg/att_cartesian.npy', att)

#features = np.array(features).astype(float)
#np.save('SNU36_mel_10K_120_0.95.npy', features)
